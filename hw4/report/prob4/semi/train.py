...
if __name__ == '__main__':
    ...
    preprocess = Preprocess(train_x[:num_label] + train_x_no_label[:num_unlabel], sen_len, w2v_path = w2v_path)
    ...
    training(batch_size, epoch, lr, model_dir, X_train, X_val, y_train, y_val, train_x_no_label, model, device, threshold, pad_index)